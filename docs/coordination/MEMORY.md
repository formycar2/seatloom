...
- [~] SG-A §A3 (Nimbus tmux pipe-pane attach read path) **DELIVERED PROVISIONAL** — commit `fca4fe0`; delivery doc posted; headless smoke harness asserts all 9 packet steps + R3 (tmux survives `kill_session`); portable-pty removed from dep graph; nix 0.29 added for mkfifo; Flux commit-pinned verify packet issued at `docs/coordination/tasks/flux/FLUX-2026-05-09-a3-tmux-mirror-verification-v1.md` (2026-05-09, Lyra / Nimbus / Flux)
- [ ] SG-A §A4-β (Mira real-API wire-up) — unblocks on Flux A3 PASS
